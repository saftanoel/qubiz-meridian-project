...
def _seed_resources(db: Session) -> None:
    resources = [
        ...
        {"id": 2, "question": "How does hybrid work actually work here?", "answer": "Each team has 'anchor days' — usually 2-3 days per week in the office. Engineering anchors on Wednesday and Thursday. Remote days are fully flexible. There's no micromanagement.", "category": "Hybrid Work"},
        {"id": 3, "question": "Which Slack channels should I join first?", "answer": "Start with #general, #new-joiners, and your team channel (#eng-frontend). For fun, try #random, #pets, and #lunch-plans. Don't worry about being in too many — you can always leave.", "category": "Slack & Communication"},
        ...
        {"id": 6, "question": "Where do people eat lunch?", "answer": "Most people eat in the main kitchen/café area. Snacks are free and refilled on Mondays. Many teams do informal lunch together — just ask in your team's Slack channel.", "category": "Office"},
    ...
    locations = [
        {
            ...
            "tips": json.dumps(["Say hi to Sarah at the front desk!", "Coffee machine here is the best one."]),
            "who_you_can_meet": "Front desk staff, arriving visitors",
        ...
        },
        {
            ...
            "who_you_can_meet": "Ioana Radu (HR Partner), the People Ops team",
        ...
        },
        {
            ...
            "who_you_can_meet": "Mara Ionescu (your manager), Vlad Marinescu, backend & infra engineers",
            "why_it_matters": "This is where your team sits — you'll spend most of your office days here.",
        },
        {
            "id": 4,
            "name": "Main Kitchen & Cafe",
            ...
            "who_you_can_meet": "Everyone — the kitchen is the great equalizer",
            "why_it_matters": "Best place for accidental conversations. Many friendships start over coffee here.",
        },
        {
            "id": 5,
            "name": "Meeting Rooms (A–D)",
            "description": "Formal meeting spaces with AV equipment and whiteboards.",
            "tips": json.dumps(["Book via Google Calendar.", "Room C has the best natural light.", "Room A has a standing desk setup."]),
            "who_you_can_meet": "Cross-functional teams during sprint planning and reviews",
            "why_it_matters": "Where you'll have your 1:1s, sprint ceremonies, and design reviews.",
        },
        {
            "id": 6,
            "name": "Quiet Zone",
            ...
            "who_you_can_meet": "Writers, developers doing deep work, analysts",
            "why_it_matters": "Perfect when you need to concentrate on learning new codebases or completing training.",
        },
        {
            "id": 7,
            "name": "Social Space & Games",
            ...
            "who_you_can_meet": "Tudor Munteanu (board game organizer), cross-team friends",
            "why_it_matters": "Easiest way to meet people outside your team. Highly recommended in week one.",
        },
    ]
