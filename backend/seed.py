...
def _seed_employees(db: Session) -> None:
    employees_data = [
        ...
        },
        {
            ...
            "is_buddy": False,
            "match_reason": "Knows the Meridian brand inside out — great for learning company culture.",
            "ask_me_about": "Meridian brand, internal events",
        ...
        },
        {
            ...
            "is_buddy": False,
            "match_reason": "Handles expenses and invoices — helpful for admin questions in your first month.",
            "ask_me_about": "Expenses, invoices, admin processes",
        ...
        },
        {
            ...
            "is_buddy": False,
            "match_reason": "Bridges the gap between product and customers — great for understanding user needs.",
            "ask_me_about": "Customer stories, quarterly goals, sales handoffs",
...
def _seed_resources(db: Session) -> None:
    resources = [
        ...
        {"id": 2, "question": "How does hybrid work at Meridian?", "answer": "Meridian follows a 3-days-in-office and 2-days-remote hybrid model. Team anchor days are used for collaboration, onboarding conversations, and meetings that benefit from being in person.", "category": "Hybrid Work"},
        ...
        {"id": 5, "question": "Who is my onboarding buddy?", "answer": "Your onboarding buddy is Ioana Radu from HR. She's your go-to for any question — even the ones that feel 'too small' to ask. Don't hesitate!", "category": "People"},
        ...
        {"id": 11, "question": "What departments does Meridian have?", "answer": "Meridian is organized around Engineering, Sales, Marketing, HR, and Finance. During onboarding, Meridian Compass helps you discover who belongs to each department and who can help with specific questions.", "category": "People"},
        {"id": 12, "question": "What communication tools does Meridian use?", "answer": "Meridian mainly uses Slack for day-to-day communication and Google Meet for video calls, onboarding sessions, and remote meetings.", "category": "Slack & Communication"},
    ]
